...
RUN Rscript -e 'remotes::install_version("terra",upgrade="never", version = "1.4-11")'
...
RUN Rscript -e 'remotes::install_github("hrbrmstr/qrencoder@95701f7f0b597dc6c547210c9b632c02afc8dcd9")'
