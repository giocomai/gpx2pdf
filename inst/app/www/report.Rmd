...
```{r qrcode, fig.align='center', fig.width=1.4, fig.height = 1.4, eval=TRUE}
if (params$url!="") {
 qrencoder::qrencode(to_encode = params$url) %>% 
   as.data.frame() %>% 
...
```{r profilo altimetrico con punti, fig.width=8, fig.height=3.5, fig.align="center"}
